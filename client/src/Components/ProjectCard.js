...
export default function ProjectCard({ id, name, category, state, priority, numTaskDone, numTask, tags, dueDate }) {
    ...
    const [url, setUrl] = useState("https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Google_%22G%22_Logo.svg/1200px-Google_%22G%22_Logo.svg.png")
